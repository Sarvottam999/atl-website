...
interface ATLJourneyWebsiteProps {
  ...
  const ATLPresentationsPage: React.FC<ATLJourneyWebsiteProps> = ({ onNavigate }) => {
  ...
  const presentations = [
    {
      ...
      driveLink: 'https://docs.google.com/presentation/d/1CshSS8Oae2muOy3YllD2OyUgxHvSS7Xna5dKbA9Y5yE/edit?slide=id.g3b3daf3ddbb_0_0#slide=id.g3b3daf3ddbb_0_0',
      embedLink: 'https://docs.google.com/presentation/d/1CshSS8Oae2muOy3YllD2OyUgxHvSS7Xna5dKbA9Y5yE/embed?start=false&loop=false&delayms=3000',
...
>
  Back to Home
      ...
      {/* Footer */}
      <footer className="py-16 px-6 bg-gray-800 text-white mt-16">
        <div className="max-w-7xl mx-auto">
